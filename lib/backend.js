...
/**
 * The account-deletion session, deliberately a different cookie from the billing one: the
 * two sessions authorize different things, and sharing a name would let whichever was set
 * last answer for both.
 */
export const ACCOUNT_COOKIE = 'sk_account';
